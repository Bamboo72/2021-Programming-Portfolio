// Jacob Schwartz - 2/7/21
// Code copied from the Big Java textbook and then modified
...
/**
 * This program encrypts a file using the Caesar cipher. I altered it to shift
 * up by 5 and then multiply by 2
 */
public class CaesarCipher {
    public static void main(String[] args) throws FileNotFoundException {
        final int DEFAULT_KEY = 5;
        int key = DEFAULT_KEY;
        String inFile = "";
        String outFile = "";
